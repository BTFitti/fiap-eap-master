...
public class App {
	...
	public static void main(String[] args) {
		...
		disciplinaService.pesquisar(null, 70, LocalDate.of(2022, 3, 1).atStartOfDay()).forEach(System.out::println);

		System.out.println("=========== `Pesquisar Disciplnas pelo nome ======");

		disciplinaService.pesquisar("COMPLIANCE & QUALITY ASSURANCE", null, null).forEach(System.out::println);
		...
		System.out.println("========= Buscar disciplina por nome ignore case =========");
		...
		System.out.println("========= Listar matriculas por curso com Criteria =========");

		matriculaService.listarPorCursoComCriteria(1L).forEach(System.out::println);
		...
		System.out.println("========= Listar alunos cidade criteria =========");
		
		alunoService.listarAlunoCidadeCriteria().forEach(System.out::println);
