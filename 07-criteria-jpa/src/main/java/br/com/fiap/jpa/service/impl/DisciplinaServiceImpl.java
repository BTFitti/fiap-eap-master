...
public class DisciplinaServiceImpl extends GenericService<Disciplina, Long> {
	...
	public List<Disciplina> listarPorCargaHoraria(Integer cargaHoraria) {
		...
		try {
			disciplinas = disciplinaDAO.listarPorCargaHoraria(cargaHoraria, getEntityManager());
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			closeEntityManager();
	...
	public List<Disciplina> pesquisar(String nome, Integer cargaHoraria, LocalDateTime dataCadastro) {
		...
		try {
			disciplinas = disciplinaDAO.pesquisar(nome, cargaHoraria, dataCadastro, getEntityManager());
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			closeEntityManager();
